...
const CreateLeague: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await leagueApiRequest.create(formDataToSend);
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Box position="relative" width="100%" pb="8">
                    <Slider
                      ...
                      onChange={(value) => handleSliderChange(playerOptions[value])}
                ...
                <div>
                  ...
                  <InputGroup>
                    <InputLeftAddon className="text-right mt-1">VND</InputLeftAddon>
                    <Input
                      type="text"
                      id="money"
                      name="money"
                      value={formatMoney(formData.money)}
